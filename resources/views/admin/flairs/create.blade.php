<x-app-layout>
    <x-slot name="title">New Flair</x-slot>
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="px-6 py-6">
                    <form method="post" action="{{ route('admin.flairs.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                placeholder="e.g., Job Referral" value="{{ old('name') }}" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                                placeholder="e.g., job-referral" value="{{ old('slug') }}" required />
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex gap-2">
                                ...
                                <x-text-input name="color" type="text" placeholder="#6366f1"
                                    class="block flex-1" value="{{ old('color', '#6366f1') }}" />
                            </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="icon" name="icon" type="text" class="mt-1 block w-full"
                                placeholder="e.g., 💼 or [JOB]" value="{{ old('icon') }}" />
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="is_sticky" value="1"
                                    class="rounded border-gray-300" @if (old('is_sticky')) checked @endif />
                        ...
                        <div class="flex gap-4">
                            <x-primary-button>{{ __('Create Flair') }}</x-primary-button>
